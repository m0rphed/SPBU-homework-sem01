...
// find smallest 'min' and highest 'max'


void printArray(int *array, int arrayLength);
// Func. provides more fancy printing for arrays.


void printArrayTilZeros(int *array, int arrayLength);
// Func. prints all elements of an array to the first zero.
